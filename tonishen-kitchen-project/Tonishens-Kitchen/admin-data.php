...
// Format order_time directly into a human-readable string like "11:07 PM"
...
// 6. Customer Feedback
$feedbackQuery = "
    SELECT f.rating, f.comment, u.fname, u.lname, u.email, u.profile_pic
    FROM feedback f
...
// 7. Customer Favorites (Top 4 Dishes)
$favoritesQuery = "
